    ...
    return (
        <div className='container ms-5 '>
            ...
            <form className='mb-3'>
                ...
                <textarea className="form-control mt-3 mb-2 shadow-none border border-secondary-subtle" id="review" rows="3" placeholder="Your Review" onChange={(e) => setReview(e.target.value)}></textarea>
                <ReactStars
                    count={5}
